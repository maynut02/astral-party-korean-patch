...
public final class MobilePatcherReleaseTest {
    ...
    public void rejectsUnexpectedReleaseUrl() throws Exception {
        MobilePatcherRelease.parse(validIndex().replace(
                "mobile-patcher-v0.1.2/AstralMobilePatcher-v0.1.2.apk",
                "mobile-patcher-v0.1.2/other.apk"));
    }
    ...
    public void rejectsVersionOutsideAndroidVersionCodeRange() throws Exception {
        MobilePatcherRelease.parse(validIndex()
                ...
                .replace("mobile-patcher-v0.1.2/AstralMobilePatcher-v0.1.2.apk",
                        "mobile-patcher-v2101.0.0/AstralMobilePatcher-v2101.0.0.apk"));
    }
        ...
        return """
                {
                  "version": "0.1.2",
                  "versionCode": 1002,
                  "downloadUrl": "https://github.com/maynut02/astral-party-korean-patch/releases/download/mobile-patcher-v0.1.2/AstralMobilePatcher-v0.1.2.apk",
