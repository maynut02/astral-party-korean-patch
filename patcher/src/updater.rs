...
use crate::registration::EXE_NAME;
#[cfg(windows)]
...
mod tests {
    ...
    fn index(version: &str) -> PatcherIndex {
        PatcherIndex {
            ...
            download_url: format!("{RELEASE_BASE}/patcher-v{version}/AstralAutoPatcher.exe"),
            sha256: "a".repeat(64),
            size: 123,
        }
    }
    ...
    fn validates_exact_release_asset_url() {
        ...
        bad.download_url = "https://example.test/AstralAutoPatcher.exe".into();
        assert!(matches!(
